...
<head>
    ...
    <link rel="shortcut icon" href="resources/img/danataIcon.ico" type="image/x-icon">
    <link rel="stylesheet" href="resources/css/all.css">
    <link rel="stylesheet" href="resourcec/css/tableSort">
...
<div class="positionDash" class="wraper">
    ...
    <div>
        <table class="table table-hover table-curved table-striped text-center">
            <thead>
            <tr class="warning">
                <th class="text-center"><a href="/train_direction_sort_list/${"name"}"/>Назва напрямку</th>
                <th class="text-center"><a href="/train_direction_sort_list/${"createDate"}"/> Дата створення</th>
                <th class="text-center"><a href="/train_direction_sort_list/${"valid"}"/>Актуальність напрямку</th>
            </tr>
